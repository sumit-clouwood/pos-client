<template>
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
            ...
            <div class="collapse navbar-collapse delivery-manager-st" id="navbarResponsive">
                <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                    <li class="nav-item logo-wrap" data-toggle="tooltip" data-placement="right" title="logo">
                        <a class="nav-link" href="#">
                            <img src="img/other/icon.png" alt="icon">
                        </a>
                    </li>

                    <li class="nav-item active-opacity" data-toggle="tooltip" data-placement="right" title="Dashboard">
                    ...
                    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="CRM">
                        <a class="nav-link" href="#">
                    ...
                    <li class="nav-item dp-dropbtn">
                        ...
                        <ul class="dp-dropdown-content">
                            ...
                            <li><a href="/pos-walkin-cashier/dispatch-screen.html">Dispatch Screen</a></li>
                        </ul>
