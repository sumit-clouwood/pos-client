<template>
    <div class="delivered-order-table">
        <table class="table table-responsive">
            ...
            <tr class="">
                <td>Iqbal University Sharjah</td>
                <td>11</td>
                <td>572.01</td>
                <td>444.51</td>
                <td>127.5</td>
