            ...
            <tr :key="index" class="dine-table-content" v-for="(order, index) in dineInOrderDetails">
                ...
                <td class="order-time-det">
                    ...
                    <g fill="#62BB31" fill-rule="nonzero">
                        ...
                        <span class="dinefor-paynow" v-if="tabName !== 'completed'"><svg height="21" viewBox="0 0 30 21" width="30"
  ...
  export default {
    ...
    methods: {
      ...
      timerClock: function (datetime, id) {
        return this.orderTimer(this.convertDatetime(datetime, this.timezoneString), this.timezoneString)
      },
    },
  }
</script>
