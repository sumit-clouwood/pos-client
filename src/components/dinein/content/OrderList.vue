<template>
                        ...
                        >
                          <svg xmlns="http://www.w3.org/2000/svg" width="22" height="19" viewBox="0 0 22 19">
                            <g fill="#fff" fill-rule="nonzero">
                              ...
                              <path d="M17.518 9.8c-.672 0-.672-1.023 0-1.023h1.643c.676 0 .676 1.023 0 1.023h-1.643z"/>
                            </g>
                          </svg>
                          {{ _t('Print') }}
                        </button>
              ...
              <div class="action-status">
                <div>
                  <button
                    ...
                    "
                  >
                    <span class="pay_now"><i class="fa fa-clock-o" aria-hidden="true"></i>
 {{ _t('About to Finish') }}</span>
                  ...
                  >
                    <span class="pay_now"> <i class="fa fa-check" aria-hidden="true"></i> {{ _t('Complete') }}</span>
                  </button>
                </div>
              </div>
            </td>
