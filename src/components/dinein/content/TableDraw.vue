        ...
        <div class="inner-dinein-table">
            ...
            <div class="sitting-dinein-table ui-droppable" id="sitting-dinein-table">
                <div class="sitting-dine-wrap disable-sorting" v-if="tablesOnArea">
                    <div class="sitting-image"  @click="orderTypeWalkIn({ OTview: 'Dine In', OTApi: 'dine_in' })" :data-target="store">
                    ...
                    <div class="dropdown-menu show tooltip-c" x-placement="bottom-start" id="tooltip-c" style="position: absolute; transform: translate3d(0px, 20px, 0px); top: 0px; left: 0px; will-change: transform;">
                        <div class="tooltip-c-range" id="range"></div>
                        <a class="dropdown-item" data-value="Table 3" href="#">Table 3</a>
                        <a class="dropdown-item" data-value="Table 3 A" href="#">Table 3 A</a>
                    </div>
                </div>
            </div>
        </div>
