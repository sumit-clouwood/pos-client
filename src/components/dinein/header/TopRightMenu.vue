<template>
    <div class="header-main-right color-dashboard-background">
        ...
        <div class="all-tables-wrap">
            <button type="" id="all-tables" data-related="all-tables-show" class="tables-btn-style active">All Tables</button>
            <button type="" id="resrvation-orders" data-related="reservation-orders-show" class="tables-btn-style">Reservation</button>
            <button type="" id="running-orders" data-related="running-orders-show" class="tables-btn-style">Running Orders</button>
            <button type="" id="completed-orders" data-related="completed-orders-show" class="tables-btn-style">Completed Orders</button>
        </div>
