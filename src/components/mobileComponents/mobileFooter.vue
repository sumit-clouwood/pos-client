    ...
    <div class="mobile-footer">
        ...
        <div class="main-orders-buttons">
            ...
            <div class="btn-chatge">
                <div class="btn-chatge-amount" @click="paymentMethodsChange" v-show="orderType.OTApi !== 'call_center'">
                    {{ formatPrice(orderTotal || 0) }}
                </div>
                <div class="btn-chatge-title" @click="paymentMethodsChange" v-show="orderType.OTApi !== 'call_center'">
                    CHARGE
                </div>
                <li
