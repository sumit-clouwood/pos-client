<template>
    <div :class="['orders-menu-overlay', {active: !footerMenuHendler}]" @click.self="footerMenuHendlerGhange">
        <div class="orders-menu">
            ...
            <div class="footer-slider-list-item footer-slider-list-item-open-orders"
                 id="hold-order-box">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z"
                          stroke="#4B4E53" stroke-linecap="square"/>
            ...
            <li class="footer-slider-list-item"
                data-toggle="modal"
            ...
            <div class="footer-slider-list-item active"
                 data-toggle="modal"
            ...
            <li class="footer-slider-list-item" data-toggle="modal" data-target="#dining-option">
                <svg width="15" height="17" viewBox="0 0 15 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 1V4C1 5.65685 2.34315 7 4 7C5.65685 7 7 5.65685 7 4V1M4 1V17V1ZM14 9C12 8.33333 11 7 11 5C11 3 12 1.66667 14 1V17V9Z"
                          stroke="#4B4E53" stroke-linecap="square"/>
                </svg>
                <a class="footer-slider-list-item-link" href="#">
            ...
            <li data-toggle="modal"
                ...
                <a href="#" class="footer-slider-list-item-link">
                    ...
                    <span v-if="loyaltyCard">
                        <span> {{ isNaN(loyaltyCard.balance) ? 0 : formatPrice(loyaltyCard.balance) }} {{ _t('Loyalty') }} </span>
                        <br>
