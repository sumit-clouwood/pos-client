            ...
            <ul class="footer-slider-list ullist-icons">
                ...
                >
                    <a href="#" class="footer-slider-list-item-link">
                        <img src="img/pos/tip.png" :alt="_t('Loyalty')" v-if="!loyaltyCard">
              ...
              <span>{{ selectedCustomer }}</span>
                ...
                <li
                        ...
                        data-dismiss="modal"
                >
                    <a class="footer-slider-list-item-link" href="#" @click="setOrderType('delivery')">
                ...
                <li class="footer-slider-list-item" data-toggle="modal" data-target="#add-note">
                    <a class="footer-slider-list-item-link" href="#">
