  ...
  <div class="main-orders-list" v-if="items">
    ...
    >
      <div class="main-orders-list-item-title color-text">
        ...
        >
                    <svg class="color-text-invert" width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
