<template>
  <div class="payment-screen-footer" id="payment-screen-footer">
    ...
    >
      <img src="/pos/img/pos/tip.png" alt="payment-method" /><span>
        {{ _t('Tip Amount') }}
      </span>
    </div>
    <div class="footer-wrap">
      <img src="/pos/img/pos/gift-receipt.png" alt="payment-method" /><span>{{
        _t('Gift Receipt')
      }}</span>
    </div>
    <div class="footer-wrap" data-toggle="modal" data-target="#add-email">
      <img src="/pos/img/pos/email.png" alt="payment-method" /><span>
        {{ _t('Email') }}
      </span>
    </div>

    <div class="footer-wrap" @click="pay">
      <img src="/pos/img/pos/done.png" alt="payment-method" /><span>
        {{ _t('Done') }}
      </span>
    </div>
  </div>
