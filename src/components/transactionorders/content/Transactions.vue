  ...
  <div class="main-body-transaction color-dashboard-background color-text">
    ...
    <div :class="['food-wrapper', 'active']">
      <div v-if="transactionOrderList.length > 0" class="left_size_details">
        ...
        <div class="detailed_block">
          <p class="date_class">Tuesday, February 26, 2019</p>
          <div class="left_info_block">
            ...
            <div class="price_and_name">
              <p class="doller_price">$133</p>
              <p class="price_s_desc">Bakmi goreng, kwetiaw, and...</p>
            </div>
            <div class="time_and_button">
              <p>4:59 PM</p>
          ...
          <div class="left_info_block">
            ...
            <div class="time_and_button">
              <p>4:59 PM</p>
              <a href="" class="refunded">Refunded</a>
            </div>
          </div>
        </div>
        <!-- One Block-->
